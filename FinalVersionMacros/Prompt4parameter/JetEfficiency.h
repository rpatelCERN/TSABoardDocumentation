...
// Wed Aug 14 16:38:12 2019 by ROOT version 5.34/37
// from TTree eventTree/Event tree
// found on file: TTBarNoPUTrackNtuple.root
//////////////////////////////////////////////////////////
...
public :
   ...
   JetEfficiency(TTree *tree=0);
   virtual ~JetEfficiency();
...
#ifdef JetEfficiency_cxx
JetEfficiency::JetEfficiency(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("H250mPhi30ctau0TrackNtuple.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("H250mPhi30ctau0TrackNtuple.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("H250mPhi30ctau0TrackNtuple.root:/L1TrackJetsFast");
...
Int_t JetEfficiency::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t JetEfficiency::LoadTree(Long64_t entry)
{
...
void JetEfficiency::Init(TTree *tree)
{
...
void JetEfficiency::Show(Long64_t entry)
{
...
Int_t JetEfficiency::Cut(Long64_t entry)
{
